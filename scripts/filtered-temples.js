...
// Criar botão de menu hamburguer para navegação responsiva
...
const temples = [
  ...
  { templeName: "Brasil Brasilia", location: "Brasilia, Brasil", dedicated: "2023, September, 17", area: 2322, imageUrl: "https://pt.thechurchnews.com/resizer/v2/WMEPX3PSHVMY5FJVTHCRTMQSUQ.jpg?auth=33fad6106744f6f1318fba9403620e20b18db0c6334d26aab381bf2768800dbd&focal=3826%2C2551&width=800&height=533" },
  { templeName: "Manila Philippines", location: "Manila, Philippines", dedicated: "1984, September, 25", area: 116642, imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Manila_Philippines_Temple_-_Whiting.jpg/1200px-Manila_Philippines_Temple_-_Whiting.jpg" }
];

// Renderizar os templos
const container = document.createElement("div");
container.id = "temple-container";
...
// Filtragem com base no menu
document.querySelectorAll("nav a").forEach(link => {
  link.addEventListener("click", (event) => {
    event.preventDefault(); // Evita recarregar a página
    const filter = link.getAttribute("href").substring(1); // Obtém o filtro do href
    ...
    switch (filter) {
      ...
      case "new":
        ...
        break;
      case "large":
        filteredTemples = temples.filter(t => t.area > 8700);
        break;
      case "small":
...
// Inicializa com todos os templos visíveis
